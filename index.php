                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                data-parent="#accordion">
                                <div class="card-body">
                                Una terapia individual para problemas de ansiedad, por ejemplo, dura entre 8 y 15 sesiones; para depresiones, la duración puede ser algo mayor, acercándose a las 14 a 18 sesiones
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapse_4" class="collapse" aria-labelledby="heading_4" data-parent="#accordion">
                                <div class="card-body">
                                    <ul>
                                        ...
                                        <li>Terapia de familia y adolescentes.</li>
